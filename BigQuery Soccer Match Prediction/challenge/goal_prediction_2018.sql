SELECT predicted_isGoal_probs[ORDINAL(1)].prob AS predictedGoalProb,
      * EXCEPT (predicted_isGoal, predicted_isGoal_probs),
FROM ML.PREDICT(MODEL `soccer.xg_logistic_reg_model_365`, (
                SELECT Events.playerId,
                ...
                /* Convert match period and event seconds to minute of match */
                  CAST((CASE
                    ...
                    ELSE 120 END) + CEILING(Events.eventSec / 60) AS INT64) AS matchMinute,
                ...
                WHERE Competitions.name = 'World Cup' AND
                  ...
                  (eventName = 'Shot' OR
                  (eventName = 'Free Kick' AND subEventName IN ('Free kick shot'))) AND
